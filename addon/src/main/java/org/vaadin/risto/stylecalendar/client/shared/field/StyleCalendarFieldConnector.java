...
public class StyleCalendarFieldConnector
    ...
    protected void init() {
        ...
        final StyleCalendarFieldRpc rpcProxy = RpcProxy
                .create(StyleCalendarFieldRpc.class, this);
        ...
        handlerRegistrations.add(getWidget()
