package org.vaadin.risto.stylecalendar.client.ui.field;
...
import org.vaadin.risto.stylecalendar.client.ui.field.event.StyleCalendarFieldValueChanged;
...
public class StyleCalendarFieldWidget extends TextBox
    ...
    public StyleCalendarFieldWidget() {
        ...
        addValueChangeHandler(new ValueChangeHandler<String>() {
            ...
            public void onValueChange(ValueChangeEvent<String> event) {
                StyleCalendarFieldWidget.this.valueChange(event.getValue());
            }
        });
